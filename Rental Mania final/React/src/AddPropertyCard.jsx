...
const AddRentalProperty = () => {
  ...
  data.append("renterName", formData.renterName);
  data.append("renterAddress", formData.renterAddress);
  data.append("phone", formData.phone);
  data.append("startDate", formData.startDate);
  data.append("documentNumber", formData.documentNumber);
    const response =  await fetch (`${backend_url}/addproperty`, {
          method: 'POST',
          body: data,
        });
  ...
  return (
    <form className="add-property-form" onSubmit={handleSubmit} method='post'>
